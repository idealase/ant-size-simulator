  ...
  return (
    <div className="app">
      ...
      <div className="panel-bottom">
        <StrengthComparison carryMultiple={outputs.carryCapacityMultiple} />
        <FunFactsPanel scaleFactor={outputs.scaleFactor} />
      </div>

      <footer className="app-footer">
        <p>
          Ant Size Simulator &middot; Explore the square-cube law &middot;{' '}
          <a href="https://github.com/idealase/ant-size-simulator" target="_blank" rel="noreferrer">
            GitHub
          </a>
        </p>
      </footer>
